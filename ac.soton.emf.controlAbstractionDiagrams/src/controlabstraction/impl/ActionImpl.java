 ...
 * </p>
 * <ul>
 *   <li>{@link controlabstraction.impl.ActionImpl#getConditions <em>Conditions</em>}</li>
 *   <li>{@link controlabstraction.impl.ActionImpl#getReliances <em>Reliances</em>}</li>
 *   <li>{@link controlabstraction.impl.ActionImpl#getAction <em>Action</em>}</li>
 *   <li>{@link controlabstraction.impl.ActionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link controlabstraction.impl.ActionImpl#getErrors <em>Errors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends AbstractNamedElementImpl implements Action {
	 ...
	 * @ordered
	 */
	protected EList<controlabstraction.Error> errors;
	 ...
	 * @generated
	 */
	public EList<controlabstraction.Error> getErrors() {
		if (errors == null) {
			errors = new EObjectContainmentEList<controlabstraction.Error>(controlabstraction.Error.class, this, ControlabstractionPackage.ACTION__ERRORS);
		}
		return errors;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ControlabstractionPackage.ACTION__ERRORS:
				getErrors().clear();
				getErrors().addAll((Collection<? extends controlabstraction.Error>)newValue);
				return;
		}
