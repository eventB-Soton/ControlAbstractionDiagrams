...
/**
 * This is the item provider adapter for a {@link controlabstraction.Error} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorItemProvider extends AbstractNamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ControlabstractionPackage.Literals.ERROR__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((controlabstraction.Error)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(controlabstraction.Error.class)) {
