...
/**
 * This is the item provider adapter for a {@link ac.soton.emf.controlabstraction.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider extends AbstractNamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ControlabstractionPackage.Literals.CONDITION__STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAssumptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_assumption_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_assumption_feature", "_UI_Condition_type"),
				 ControlabstractionPackage.Literals.CONDITION__ASSUMPTION,
				 false,
				 false,
				 false,
