...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>controlabstraction</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlabstractionExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ControlabstractionPackage.eNS_URI, 
			 ControlabstractionPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.cabs"));
				Component root = ControlabstractionFactory.eINSTANCE.createComponent();
